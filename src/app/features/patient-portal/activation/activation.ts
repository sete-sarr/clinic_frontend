...
export class Activation {
  ...
  // Aucun bouton retour n'existait entre les étapes — l'assistant repose uniquement sur un état
  // côté client (pas piloté par l'URL), donc même le bouton retour du navigateur ne peut rien une fois
  // passé 'identify' ; un patient ayant mal saisi son téléphone/sa clinique restait bloqué et devait
  // recharger toute la page (signalé par un utilisateur, 2026-09-15).
